...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/29 22:17:06 by agusev            #+#    #+#             */
/*   Updated: 2019/04/29 22:35:16 by agusev           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ft_strstr(line, "p1") && ft_strstr(line, "agusev"))
	{
		filler->player = 'O';
		filler->enemy = 'X';
	}
	else if (ft_strstr(line, "p2") && ft_strstr(line, "agusev"))
	{
		filler->player = 'X';
		filler->enemy = 'O';
	}
...
void	read_input(t_filler *filler, char *line, int *index)
{
	if (!filler->player)
